...
class AuthService {
  ...
  public async login(credentials: ILoginCredentials): Promise<IUser> {
    try {
      ...
      const user: IUser = {
        ...
        permissions: [
          ...getPermissionsByUserType(type, permissions as IPermissionValue[]),
        ],
        name: type,
        type: type,
        ...
        //   'delete_role',
        //   'approve_role',
        //   'view_sub_distributor',
        //   'create_sub_distributor',
        //   'edit_sub_distributor',
        //   'delete_sub_distributor',
        //   'approve_sub_distributor',
        //   'view_sr',
        //   'create_sr',
        //   'edit_sr',
        //   'delete_sr',
        //   'approve_sr',
        //   'generate_virtual_balance',
        //   'approve_virtual_balance',
        //   'view_category',
        //   'create_category',
        //   'edit_category',
        //   'delete_category',
        ...
        //   'view_additional_category',
        //   'create_additional_category',
        //   'edit_additional_category',
        //   'delete_additional_category',
        //   'view_product',
        //   'create_product',
        //   'edit_product',
        //   'delete_product',
      ...
      if (axios.isAxiosError(error)) {
        throw new Error(
          error.response?.data?.error?.reason.join(', ') || 'Login failed'
        );
      }
      throw error;
    }
  ...
  public isRefreshTokenExpired(refreshExpiresAt?: number): boolean {
    ...
    console.log(
      ...
      Math.floor(Date.now() / 1000) >= refreshExpiresAt
    );
