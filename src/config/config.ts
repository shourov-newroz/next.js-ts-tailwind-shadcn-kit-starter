export const BACKEND_BASE_URL =
  process.env.VITE_API_BASE_URL || 'http://3.253.31.137:8085';
export const CLIENT_ID = process.env.VITE_API_CLIENT_ID || 'mobile-app';
export const CLIENT_SECRET =
  process.env.VITE_API_CLIENT_SECRET || '1kfwIxOSyWfcSnrcSpFeRdX0j2kAYasi';
